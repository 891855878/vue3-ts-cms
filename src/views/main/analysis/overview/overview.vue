<template>
  <div class="overview">
    ...
    <ky-card title="技术栈">
      <Ky-text-link :text-arrs="technologyStacks" />
      <ky-descriptions
        title="生产环境依赖"
        :column="2"
    ...
    <ky-card title="项目结构">
      <div class="c-left">
        <ky-code language="bash" :code="projectDir" />
      </div>
    </ky-card>
    <ky-card title="项目规范">
      <ky-descriptions
...
import kyDescriptions from "@/base-ui/descriptions";
import KyTextLink from "@/base-ui/text-link";
import KyCode from "@/base-ui/code";
import KyCard from "@/base-ui/card";
